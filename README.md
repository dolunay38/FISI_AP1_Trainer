[README (1).md](https://github.com/user-attachments/files/31865589/README.1.md)
...
## 10. Über die private Vollversion

Diese Vorlage ist bewusst leer. In meiner eigenen, privaten Version davon sind mittlerweile **41 Module mit über 1.000 Karten** entstanden – u. a. ein kompletter AP1-Theoriekatalog (11 Kapitel), original IHK-Prüfungssätze mehrerer Jahrgänge, KI-generierte Übungsprüfungen und ein umfangreicher AP2-Lernkatalog.

Diese Inhalte werden hier **nicht** veröffentlicht: Ein Teil der Original-Prüfungssätze ist kostenpflichtig erworben und urheberrechtlich geschützt, ein weiterer Teil wurde von einem Kommilitonen bzw. einem Freund beigesteuert und ist nicht allein meins zum Weitergeben. Diese Vorlage enthält daher ausschließlich die Funktionalität – der Lerninhalt bleibt bewusst dir überlassen.
